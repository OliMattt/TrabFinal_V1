...
public class Spike {
    ...
    public Spike(Context context) {
        ...
        random = new Random();
        resetPosition(); //reset X, Y && Velocity
    }

    // BitMap para capturar a imagem do spike
    public Bitmap getSpike(int spikeFrame) {
        return spike[spikeFrame];
    }
    //Todos Spikes tem o mesmo tamanho, entao pode chamar qualquer um
    ...
    //Resetar posição do spike com posições aleatorias
